...
@endsection
@section('headcontent') Data User @endsection
        ...
        <div class="card">
            <div class="card-header">
                ...
                @if (!empty($permissionAdd))
                    <a href="{{ url('panel/user/add') }}" class="btn btn-primary float-right btn-sm">Add</a>
                @endif
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                @if (!empty($permissionEdit))
                                    <a href="{{ url('panel/user/edit/'.$value->id) }}" class="btn btn-info btn-sm">Edit</a>
                                @endif
