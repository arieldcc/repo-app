...
@section('headcontent') Edit Fakultas @endsection
            ...
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_fakultas" value="{{ $getRecord->nama_fakultas }}" class="form-control" required id="nama_fakultas" placeholder="Input Nama Fakultas">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select required name="jenjang_didik_id" id="jenjang_didik_id" class="form-control select2">
                        ...
                        @foreach ($getJenjangPendidikan as $value)
                            <option {{ $getRecord->jenjang_didik_id == $value->id_jenjang_didik ? 'selected' : '' }} value="{{ $value->id_jenjang_didik }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="singkatan" value="{{ $getRecord->singkatan }}" class="form-control" required id="singkatan" placeholder="Input Nama Jenis Jabatan">
                </div>
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-primary float-right"><i class="fas fa-check"></i> Update</button>
