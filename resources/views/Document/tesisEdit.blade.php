...
@section('title') Edit Tesis @endsection
...
@section('headcontent') Edit Tesis @endsection

@section('content')
<div class="row">
    <div class="col-lg-8 offset-lg-2">
        <form action="{{ url('doc/tesis/edit/'.$getRecord->document_id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card card-warning">
                <div class="card-header d-flex align-items-center">
                    <h4 class="card-title text-white mb-0 flex-grow-1">Form Edit Tesis</h4>
                    <a href="{{ url('doc/tesis') }}" class="btn btn-sm btn-warning text-dark">
