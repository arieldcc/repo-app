...
@section('title') Detail Tesis @endsection
...
@section('headcontent') Detail Tesis @endsection
    ...
    <div class="col-lg-8 offset-lg-2">
        <div class="card">
            <div class="card-header bg-info d-flex align-items-center">
                <h4 class="card-title text-white mb-0 flex-grow-1">Informasi Tesis</h4>
                <a href="{{ url('doc/tesis') }}" class="btn btn-sm btn-info text-dark">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-sm-4 label-detail">Judul Tesis</div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8 value-detail">
                        @php
                            ...
                            $fileUrl = $filePath ? url('/public/storage/uploads/tesis/' . $filePath) : null;
                ...
                <div class="text-right mt-4">
                    <a href="{{ url('doc/tesis') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali ke Daftar</a>
                </div>
